<template>
  <section class="main-content">
    <section class="main-header">
      <h1>Fundamentos de</h1>
      <h1 class="js-title">JavaScript</h1>
    </section>
    <section class="first-copy">
      <p>Durante mucho tiempo, omití el aprender JavaScript a pesar de saber que era esencial aprenderlo para volverme desarrollador web. Algunas de las razones por las no me comprometía a aprende eran:</p>
      <ul class="bullet-list">
        ...
        <li>Había demasiada información sobre qué aprender, cómo aprenderlo, este exceso de recursos me agobiaba y al final decidía postergar mi aprendizaje porque quería que fuera perfecto</li>
      </ul>

...
Cumple al misma función que `undefined`, al representar una ausencia de valor, pero con la gran diferencia que este tipo de dato es la forma de nosotros decirle a la computadora que queremos que algo carezca de valor asignado.

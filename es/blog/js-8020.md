...
Para poder usar el valor calculado al interior de la función necesitamos regresar ese valor como resultado de la función, para eso se usará la palabra reservada `return`.
...
```javascript
console.log(sumarNums(1+2)); // Imprimirá: undefined

...
Como vimos anteriormente las fuciones son bloques de código aislados que realizan tareas específicas.
...
Explica retrun
Explicar funcoines dentor objetos, o sea solo que no necesitan la function keyword que con la pura sintaxis JavaScript ya sabe que es una función

Resumen

recapitular los conceptos de ahsta rriba y explicar:

Ah pues require es una funcion que acepta este parametro y que te regresa un objeto que estamos guardando en una vairbale, ese objeto tiene metodos dentro que son los que se acceden en la línea 2 bla blabla
